...
export function PopoverTitle({ className, ...props }: BasePopover.Title.Props) {
	return <BasePopover.Title data-slot="popover-title" {...props} className={cn("font-semibold", className)} />;
}

export function PopoverDescription({ className, ...props }: BasePopover.Description.Props) {
	return <BasePopover.Description data-slot="popover-description" {...props} className={cn("leading-relaxed text-muted", className)} />;
}
