import type { TooltipRootProps } from "~primitives/tooltip";
import { Tooltip as BaseTooltip } from "~primitives/tooltip";
		...
		<BaseTooltip.Portal>
			...
			>
				<BaseTooltip.Popup
					...
					{...props}
					className={cn(
						"rounded bg-tertiary text-tertiary-foreground shadow",
